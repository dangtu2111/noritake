...
padding-top: 1em !important;
				...
				<link href='//theme.hstatic.net/200000296482/1001063914/14/check_out.css?v=5233' rel='stylesheet' type='text/css'  media='all'  />
                    ...
                    window.onpageshow = function(event) {
                        if (event.persisted) {
                            var currentUrl = '';
                                ...
                                currentUrl = '/checkouts/ac14d99205094a8f96d02145e349f703?step=2';
					...
					function funcFormOnSubmit(e) {
						...
						if(formId == 'form_update_location_customer_shipping' ||  formId == 'form_update_shipping_method' || formId=='section-shipping-rate' || formId=='section-payment-method'){
							...
							if(formId == 'form_next_step' || formId=="checkout_complete") {
								...
								replaceElement = [...replaceElement,'.step-sections',
								...
								replaceElement = [...replaceElement,'.order-summary-toggle-inner .order-summary-toggle-total-recap',
								'.order-summary-sections',
...
Haravan.theme = {"name":"Main Noritake Template (Trai dev)","id":1001063914,"role":"main"};
...
<script>
  ...
  gtag('config', 'AW-357987955');
</script>
<script defer src='https://stats.hstatic.net/beacon.min.js' hrv-beacon-t='200000296482'></script><style>.grecaptcha-badge{visibility:hidden;}</style>
<script type='text/javascript'>
window.HaravanAnalytics = window.HaravanAnalytics || {};
window.HaravanAnalytics.meta = window.HaravanAnalytics.meta || {};
window.HaravanAnalytics.meta.currency = 'VND';
var meta = {"page":{"pageType":"checkout","resourceType":"checkout","resourceId":"ac14d99205094a8f96d02145e349f703","customerId":1142071300},"cart":{"products":[{"variantId":1079135998,"productId":1036053562,"price":1365800000.0,"name":"Bộ ấm chén uống trà (ấm 1.250ml, chén 245ml) 15 món sứ xương | Bogart Platinum 4958L - T017A - Bogart Platinum","sku":"4958L - T017A","vendor":"Bogart Platinum 4958L","variant":"Bogart Platinum","type":"Fine Dining style","quantity":1}],"item_count":1,"total_price":1365800000.0}};
...
<script>
//<![CDATA[
window.HaravanAnalytics.ga = "UA-163704659-3";
...
$.getScript('//theme.hstatic.net/200000296482/'+idtheme +'/14/checkout_script.js?v='+ (new Date()).getTime());
} catch (e) {};
                //]]>
                </script>
                <script>
window.HaravanAnalytics.fb = "1070882043321566";
//<![CDATA[
...
fbq('init', "1070882043321566", {} , {'agent':'plharavan'});
fbq('track', 'PageView');
//]]>
</script>
<noscript><img height='1' width='1' style='display:none' src='https://www.facebook.com/tr?id=1070882043321566&amp;ev=PageView&amp;noscript=1'/></noscript><!-- Event snippet for PAGE_VIEW-0-06/02/2021 07:04:26 conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-357987955/YcwuCN3zirUCEPPs2aoB'});
</script>
			...
			<button class="order-summary-toggle order-summary-toggle-hide">
				<div class="wrap">
					<div class="order-summary-toggle-inner">
						...
						<div class="order-summary-toggle-total-recap" data-checkout-payment-due-target="1365800000">
							<span class="total-recap-final-price">13,658,000₫</span>
						</div>
					</div>
				</div>
			</button>
												...
												<tbody>
													<tr class="total-line total-line-subtotal">
														...
														<td class="total-line-price">
															<span class="order-summary-emphasis" data-checkout-subtotal-price-target="1365800000">
																13,658,000₫
															</span>
														</td>
													</tr>
												...
												<tfoot class="total-line-table-footer">
													<tr class="total-line">
														...
														<td class="total-line-name payment-due">
															...
															<span class="payment-due-price" data-checkout-payment-due-target="1365800000">
																13,658,000₫
															</span>
															<span class="checkout_version" display:none data_checkout_version="40">
															</span>
														</td>
													</tr>
												</tfoot>
									...
									<ul class="breadcrumb">
										<li class="breadcrumb-item">
											...
											<li class="breadcrumb-item ">
													...
													<a href="/checkouts/ac14d99205094a8f96d02145e349f703?step=1" class="breadcrumb-link">
																...
																<div class="content-box">
																		...
																		<div class="content-box-row">
																			<div class="radio-wrapper">
																				<label class="radio-label" for="shipping_rate_id_1753806">
																					<div class="radio-input">
																						<input id="shipping_rate_id_1753806" class="input-radio" type="radio" name="shipping_rate_id" value="1753806" checked />
																					</div>
																					<span class="radio-label-primary">Freeship đơn 10tr</span>
													...
													<div class="section-content">
														<div class="content-box">
																	...
																	<div class="radio-wrapper content-box-row">
																		<label class="two-page" for="payment_method_id_1002984760">
																			<div class="radio-input payment-method-checkbox">
																				<input type-id='8' id="payment_method_id_1002984760" class="input-radio" name="payment_method_id" type="radio" value="1002984760" checked />
																			</div>
																			
																			<div class='radio-content-input'>
																				<img class='main-img' src="https://hstatic.net/0/0/global/design/seller/image/payment/vnpay_new.svg?v=6"/>
																				<div class='content-wrapper'>
																				<span class="radio-label-primary">Thẻ ATM/Visa/Master/JCB/QR Pay qua cổng VNPAY</span>
																				<span class='quick-tagline hidden'></span>
																				
																					
																						<img class="child-img" src="https://hstatic.net/0/0/global/design/seller/image/payment/atm_visa_master_jcb.svg?v=6"/>
																	...
																	<div class="radio-wrapper content-box-row">
																		<label class="two-page" for="payment_method_id_1003822098">
																			<div class="radio-input payment-method-checkbox">
																				<input type-id='2' id="payment_method_id_1003822098" class="input-radio" name="payment_method_id" type="radio" value="1003822098"  />
																			</div>
																		...
																		<div class="radio-wrapper content-box-row content-box-row-secondary hidden" for="payment_method_id_1003822098">
																			<div class="blank-slate">																		
																				Vui lòng chuyển khoản về số tài khoản:
Công ty TNHH NRTK
1106 2037 9999
Ngân hàng TMCP Công Thương Việt Nam - Chi nhánh 1
----------------------------------------------------------------------------------------
Nội dung chuyển khoản: [Tên khách hàng] [SĐT] đặt hàng Noritake
																			</div>
																		</div>
...
<form action='/checkouts/complete' id='checkout_complete' method='post' >
<input name='form_type' type='hidden' value='checkout'>
<input name='utf8' type='hidden' value='✓'>
																<input name="masked_card_id" type="hidden" value="">
...
<input name='__RequestVerificationToken' type='hidden' value='CfDJ8FyFPV59mBtNhmQGz0fYZt8ftt4rEkX91IyOSqev5LugVxP-jj1V3aakSoDL7uRifiSlhOtMLjI9aZppVFE0ymA5lWhqJC7ZoYlB8rWltOV24NYm2V0PeGs6qtSKsSFRmJu5otHALdF7J9j_14lU2tpibLWqVbx4Kjr9wit5a5wgvHYyGIkf-Y1h8ob2Kw5ZPA'>
