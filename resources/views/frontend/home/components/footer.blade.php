          ...
          <div class="col-12 col-sm-4 site-animation col-footer-1">
            ...
            <div class="col-9 col-sm-12 col-md-12 col-lg-9 col-xl-9" style="padding: 0; margin: 0 0 13px 0;">
              <form accept-charset='UTF-8' action='https://noritake.vn/account/contact' class='contact-form'
                ...
                <script>let recaptchaElm = document.getElementById('c8f55ef940824e14a6c2d210af3329a4'); let recaptchaForm = recaptchaElm.parentNode; recaptchaForm.addEventListener("submit", function (formEvent) { if (!recaptchaElm.value) { formEvent.preventDefault(); grecaptcha.ready(function () { grecaptcha.execute('6LchSLkqAAAAABVHBpeFgg8N-WgkYsr5fO6GUF_s', { action: 'submit' }).then(function (token) { recaptchaElm.value = token; recaptchaForm.requestSubmit(formEvent.submitter) }) }) } })</script>
              </form>
            </div>
