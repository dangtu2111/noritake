...
<section id="sectionInfoFooter" class="clearfix">
  <div class="footer-top">
    <ul class="row footer-top-trai">
      <li class="column_trai w6 top"><i class="fa fa-circle" aria-hidden="true"></i><a
          href="pages/chinh-sach-doi-tra.html">Chính sách giao hàng & đổi trả</a></li>
      <li class="column_trai w4 top"><i class="fa fa-circle" aria-hidden="true"></i><a
          href="pages/chinh-sach-bao-mat.html">Chính sách bảo mật</a></li>
      <li class="column_trai w6 bot"><i class="fa fa-circle" aria-hidden="true"></i><a
          href="pages/dieu-khoan-dich-vu.html">Phương thức thanh toán</a></li>
      <li class="column_trai w4 bot"><i class="fa fa-circle" aria-hidden="true"></i><a
          href="pages/huong-dan-su-dung.html">Hướng dẫn sử dụng</a></li>
    </ul>
  </div>
    ...
    <div class="row innerInfoFooter clearfix">
      <div class="col-12 col-sm-4 site-animation col-footer-1">
        ...
        <div class="col-9 col-sm-12 col-md-12 col-lg-9 col-xl-9" style="padding: 0; margin: 0 0 13px 0;">
          <form accept-charset='UTF-8' action='https://noritake.vn/account/contact' class='contact-form'
            method='post'>
            ...
            <input name='__RequestVerificationToken' type='hidden'
              value='CfDJ8FyFPV59mBtNhmQGz0fYZt_c0YksJidjGQ-Nt1gusScYneRZEG0n55dUbXkXnLdiJykFZ9cjvJM77N34CSE-UjXUYhwEMecdQS5Y7UmVyZFRq0SH93BtKkq3CSPuJlFp9CaBumKSTii1r6jWQxDfZY8'>
            <input id='c8f55ef940824e14a6c2d210af3329a4' name='g-recaptcha-response' type='hidden'>
            <script
              src='../www.google.com/recaptcha/api030a.js?render=6LchSLkqAAAAABVHBpeFgg8N-WgkYsr5fO6GUF_s'></script>
            <script>
        ...
        <!--<ul class="footer-text-line-test">
					<li><i class="fa fa-phone"></i></li>
					<li><p>Hotline: 0934 033 988 (8:00-22:00 hàng ngày)</p></li>
				</ul>
				<ul class="footer-text-line-test">
					<li><i class="fa fa-envelope"></i></li>
					<li><p>Email: contact@noritake.vn</p></li>
				</ul>-->
      ...
      <div class="col-12 col-sm-4 site-animation col-footer-2">
        ...
        <!--<ul>
								<a class="link-showroom-home" href="#">
									<img src="https://file.hstatic.net/200000296482/file/he-thong-showrroom_dbe80edefc0947d494fbd903174efca4.jpg" alt="Store">
								</a>
								<a class="store_bellow_link" href="#">Xem địa chỉ showroom gần nhất >></a>
							</ul>-->
      ...
      <div class="col-12 col-sm-4 site-animation col-footer-3">
        ...
        <div class="icon-trai"
          ...
          <ul class="navbar-social">
            <li class="social">
              @if (!empty($systems['contact_slug_logo1']) && !empty($systems['contact_logo1']))
              <a data-eventlabel="instagram" class="link-social" href="{{ $systems['contact_slug_logo1'] }}" target="_blank" rel="nofollow">
                <img class="icon-social instagram" src="{{ $systems['contact_logo1'] }}">
              </a>
              @endif
            </li>
            <li class="social">
              @if (!empty($systems['contact_slug_logo2']) && !empty($systems['contact_logo2']))
              <a data-eventlabel="zalo" class="link-social" href="{{ $systems['contact_slug_logo2'] }}" target="_blank" rel="nofollow">
                <img class="icon-social zalo" src="{{ $systems['contact_logo2'] }}">
              </a>
              @endif
            </li>
            <li class="social">
              @if (!empty($systems['contact_slug_logo3']) && !empty($systems['contact_logo3']))
              <a data-eventlabel="youtube" class="link-social" href="{{ $systems['contact_slug_logo3'] }}" target="_blank" rel="nofollow">
                <img class="icon-social youtube" src="{{ $systems['contact_logo3'] }}">
              </a>
              @endif
            </li>
            <li class="social">
              @if (!empty($systems['contact_slug_logo4']) && !empty($systems['contact_logo4']))
              <a data-eventlabel="linkedin" class="link-social" href="{{ $systems['contact_slug_logo4'] }}" target="_blank" rel="nofollow">
                <img class="icon-social linkedin" src="{{ $systems['contact_logo4'] }}">
              </a>
              @endif
            </li>
            <!--<li class="social"> 
          ...
          <div class="navbar-social-1">
            <a style="text-align: right;" href="http://online.gov.vn/Home/WebDetails/80881"><img
                src="../file.hstatic.net/200000296482/file/bo-cong-thuong_3489dcf13995496c92881750ea9c9628.png" /></a>
          </div>
        </div>
  ...
  <div class="footer-bot">
    <div class="footer-bot-trai">
      <p>© 2021 - 2024 - Bản quyền thuộc về Công ty TNHH NRTK - GĐKKD số 0316678810 do SKH&ĐT Tp. Hồ Chí Minh cấp
        ngày 20/01/2021.</p>
    </div>
  </div>
</section>
<div class="addThis_listSharing d-none">
  <ul class="addThis_listing">
    ...
    <li class="addThis_item">
      <a class="addThis_item--icon" href="http://zalo.me/3535660045369223497" target="_blank"
    ...
    <li class="addThis_item">
      <a class="addThis_item--icon"
        href="https://www.google.com/maps/place/Noritake+Việt+Nam/@10.7733732,106.7247518,17z/data=!3m1!4b1!4m5!3m4!1s0x3175255cfaed7b6f:0xed24bb04136b5a20!8m2!3d10.7733732!4d106.7269405"
        aria-label="Liên hệ" rel="noreferrer">
...
<div id="addthis-modalContact" class="modal fade modal-addThis modal-contactform" tabindex="-1" role="dialog"
    ...
    <div class="modal-content">
      ...
      <div class="modal-body body-popupform">
        <form accept-charset='UTF-8' action='https://noritake.vn/contact' class='contact-form' method='post'>
          ...
          <div class="row">
            <div class="col-12">
              <div class="input-group mb-3">
                <input required type="text" class="form-control" id="yourname" name="contact[name]"
                  placeholder="Tên của bạn" aria-label="Tên của bạn">
              </div>
            </div>
            <div class="col-12">
              <div class="input-group mb-3">
                <input required type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control"
                  id="youremail" name="contact[email]" placeholder="Email của bạn" aria-label="Email của bạn">
              </div>
            </div>
            <div class="col-12">
              <div class="input-group mb-3">
                <input required pattern="\+?\(?\d{2,4}\)?[\d\s-]{3,}" maxlength="18" type="text" id="yourphone"
                  name="contact[phone]" class="form-control" placeholder="Số điện thoại của bạn"
                  aria-label="Số điện thoại của bạn">
              </div>
            </div>
            <div class="col-12">
              <div class="input-group mb-3">
                <textarea required placeholder="Nội dung" class="form-control" id="yourinfor" name="contact[body]"
                  rows="3" aria-label="Nội dung"></textarea>
              </div>
            </div>
            <div class="col-12">
          ...
          <input id='da50cddbf79b428595434c207502e686' name='g-recaptcha-response' type='hidden'><noscript
            src='../www.google.com/recaptcha/api030a.js?render=6LchSLkqAAAAABVHBpeFgg8N-WgkYsr5fO6GUF_s'></noscript><noscript>let
            recaptchaElm=document.getElementById('da50cddbf79b428595434c207502e686');let
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-icon sweet-alert">
        <div class="sa-icon sa-success animate"> <span class="sa-line sa-tip animateSuccessTip"></span> <span
...
<style>
  ...
  .actionToolbar_mobile {
    ...
    /* Chuyển động kéo dài 0.3 giây */
  }

  .actionToolbar_mobile-trai {
    height: 60px !important;
    padding: 6.5px !important;
  }

  .actionToolbar_mobile-trai img {
    width: 30px;
    /* Đặt chiều rộng cho tất cả các SVG */
    height: 30px;
    /* Đặt chiều cao cho tất cả các SVG */
  }
  ...
  .selector-actions.selector-actions_bottom-mb {
    transition: transform 0.2s ease-in-out;
  }
</style>
