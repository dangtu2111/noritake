    ...
    <div class="footer-top">
        <ul class="row footer-top-trai">
            @foreach([
                ...
                <li class="column_trai {{ $link['class'] }}">
            ...
            <div class="col-12 col-sm-4 site-animation col-footer-3">
                ...
                <div id="container1" style="width:100%;">
                    @if(!empty($systems['contact_website']))
                        <div class="fb-page" data-href="{{ $systems['contact_website'] }}" data-tabs="" data-width="555px" data-height="300px" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                            <blockquote cite="{{ $systems['contact_website'] }}" class="fb-xfbml-parse-ignore">
                                <a href="{{ $systems['contact_website'] }}">{{ $systems['contact_website'] }}</a>
                            </blockquote>
                        </div>
                    @endif
                </div>
                <div class="icon-trai" style="display: flex; justify-content: space-between; align-items: center; margin-top: 5px;">
                    ...
                    <div class="navbar-social-1">
                        <a style="text-align: right;" href="http://online.gov.vn/Home/WebDetails/80881">
                            <img src="../file.hstatic.net/200000296482/file/bo-cong-thuong_3489dcf13995496c92881750ea9c9628.png" />
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body body-popupform">
                <form accept-charset='UTF-8' action='https://noritake.vn/contact' class='contact-form' method='post'>
                    ...
                    <input id='da50cddbf79b428595434c207502e686' name='g-recaptcha-response' type='hidden'>
                    <noscript src='../www.google.com/recaptcha/api030a.js?render=6LchSLkqAAAAABVHBpeFgg8N-WgkYsr5fO6GUF_s'></noscript>
                    <noscript>
                        let recaptchaElm=document.getElementById('da50cddbf79b428595434c207502e686');
                        let recaptchaForm=recaptchaElm.parentNode;
                        recaptchaForm.addEventListener("submit",function(formEvent){
                            if(!recaptchaElm.value){
                                formEvent.preventDefault();
