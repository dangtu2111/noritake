        ...
        <nav class="f-nav nav-wrap-menu">
            <ul class="f-nav-one wrap-menu">
                ...
                <li class="hidden-on-small ">
                    <a href="collections/tim-theo-bo-suu-tap-collections-search.html" title="Tìm theo bộ sưu tập">Tìm
                        theo bộ
                    ...
                    <ul class="f-nav-two 1">
                        ...
                        <li class="has-sub">
                            ...
                            <a href="collections/tim-theo-bo-suu-tap-collections-search.html#su-xuong-bone-china"
                                title="Sứ xương">
                                Sứ xương<svg class="icon--arrow-right" viewBox="0 0 20 20"
                            ...
                            <ul class="f-nav-three trai ">
                                ...
                                <li>
                                    <a href="collections/odessa-cobalt-platinum-4922l.html"
                                        title="Odessa Cobalt Platinum">
                            ...
                            <ul class="f-nav-three trai ">
                                ...
                                <li>
                                    <a href="collections/trefolio-hc-4977l.html"
                                        title="Trefolio HC (Holiday Christmas)">
                        ...
                        <li class="has-sub">
                            ...
                            <a href="collections/su-trang-white-porcelain.html" title="Sứ trắng">
                                Sứ trắng<svg class="icon--arrow-right" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M8 16a.999.999 0 0 1-.707-1.707L11.586 10 7.293 5.707a.999.999 0 1 1 1.414-1.414l5 5a.999.999 0 0 1 0 1.414l-5 5A.997.997 0 0 1 8 16"
                                        fill-rule="evenodd" stroke-linecap="square"></path>
                            ...
                            <ul class="f-nav-three trai  n10">
                                ...
                                <li>
                                    <a href="collections/crestwood-cobalt-gold-4171l.html"
                                        title="Crestwood Cobalt Gold">
                                        Crestwood Cobalt Gold
                                    </a>
                                </li>
                                <li>
                                    <a href="collections/crestwood-cobalt-platinum-4170l.html"
                                        title="Crestwood Cobalt Platinum">
                            ...
                            <ul class="f-nav-three trai  n10">
                                ...
                                <li>
                                    <a href="collections/princess-bouquet-gold-1660l.html"
                                        title="Princess Bouquet Gold">
                            ...
                            <ul class="f-nav-three trai  n10">
                                ...
                                <li>
                                    <a href="collections/princess-bouquet-platinum-1661l.html"
                                        title="Princess Bouquet Platinum">
                        ...
                        <li class="has-sub">
                            ...
                            <a href="collections/tim-theo-bo-suu-tap-collections-search.html"
                                title="Sứ tái chế (Made in Japan)">
                ...
                <li class="hidden-on-small ">
                    <a href="{{ route('home_index.index') }}" title="Tìm theo chức năng">Tìm theo chức năng<svg
                    ...
                    <ul class="f-nav-two 1">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="f-nav-three trai n15">
                                ...
                                <li>
                                    <a href="collections/bo-am-chen-uong-tra-18-den-21-mon.html"
                                        title="Bộ ấm trà 18 - 21 món">
                                        Bộ ấm trà 18 - 21 món
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="f-nav-three trai n15">
                                <li>
                                    <a href="collections/bo-bat-dia-an-kieu-a-22-mon.html"
                                        title="Bộ bát đĩa kiểu Á 22 món">
                                        Bộ bát đĩa kiểu Á 22 món
                                    </a>
                                </li>
                                <li>
                                    <a href="collections/bo-bat-dia-an-kieu-a-38-mon.html"
                                        title="Bộ bát đĩa ăn kiểu Á 38 món">
                ...
                <li class="hidden-on-small ">
                    <a href="{{ route('home_index.index') }}" title="Khách hàng doanh nghiệp">Khách hàng doanh
                        nghiệp<svg class="icon--arrow-bottom" viewBox="0 0 12 8">
                            <path stroke="currentColor" stroke-width="2" d="M10 2L6 6 2 2" fill="none"
                                stroke-linecap="square">
                            </path>
                        </svg></a>
