<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
                    ...
                    <div
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('product.catalogue.index') }}">Danh
                                        sách</a>
                                </li>
            ...
            <form action="{{ route('product.catalogue.edit', ['slug' => $productCatalogue->slug]) }}" method="POST"
                        ...
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="slug" class="form-control"
                                                        id=""
                                                        value="{{ old('slug', $productCatalogue->slug) }}"
                                ...
                                <div>
                                    <label>Mô tả</label>
                                    <div>
                                        <textarea class="form-control ck-editor" id="description"  name="description" rows="7">{{ old('description', $productCatalogue->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select setUpSelect2" name="order">
                                        ...
                                        @foreach ($orders as $key => $order)
                                            <option value="{{ $order->order }}" {{ $order->order == $productCatalogue->order ? 'selected' : ''}}>
                                                {{ $order->order }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select setUpSelect2" name="publish">
                                        ...
                                        <option value="1" {{ $productCatalogue->publish == 1 ? 'selected' : '' }}>Hiển thị
                                        </option>
                                        <option value="0" {{ $productCatalogue->publish == 0 ? 'selected' : '' }}>Ẩn</option>
                                    </select>
                                    ...
                                    <div class="text-center">
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <span class="image-target">
                                                <img src="{{ old('image', $productCatalogue->image ?? '') ? ''. old('image', $productCatalogue->image ?? '') : '/libaries/upload/images/img-notfound.png' }}"
                                                    alt=""
                                                    class="render-image  object-fit-contain rounded-1 mb-2 position-relative "
                                                    width="96" height="96">
                                            </span>
                                            {{-- input ẩn gửi lên controller xử lý  --}}
                                            <input type="hidden" name="image" value="{{ $productCatalogue->image }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
