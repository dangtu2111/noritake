    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row" >
                            ...
                            <div class="align-items-center">
                                ...
                                <div class="pt-3 pb-3">
                                    <span style="line-height: 1.4rem">Thông tin bạn đang muốn xóa là<span
                                            class="text-danger fw-bold fz-14"> {{  $homeComponent->type }}.</span> Không thể khôi phục!</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-7">
                    <form action="{{ route('attribute.catalogue.destroy', ['id' => $homeComponent->id]) }}" method="POST" >
                        @csrf
                        @method('DELETE')
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name" id=""
                                                value="{{ $homeComponent->type }}" readonly>
                                            @if ($errors->has('name'))
