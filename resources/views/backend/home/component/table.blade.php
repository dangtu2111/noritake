        ...
        <tbody class="list form-check-all">
                    ...
                    <td class="customer_single_td" style="">
                        ...
                        <div style="line-height: 2.2rem">
                            <div>
                                <span class="fw-medium fz-16">ádfasdfasdf</span>
                            </div>
                            <div>
                                                                    <div>
                                        <span>Danh mục:
                    ...
                    <td>
                        <div class="dropdown text-end">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink5" style="">
                                ...
                                <li><a class="dropdown-item text-info" href="http://127.0.0.1:8000/post/update/xxxxxx-74779"> <i class="ri-edit-box-line"></i>
                                        Chỉnh sửa</a></li>

                                <li><a class="dropdown-item text-danger" href="http://127.0.0.1:8000/post/delete/2"><i class="ri-delete-bin-line"></i>
                                        Xóa</a></li>
                            </ul>
                        </div>
                    </td>
